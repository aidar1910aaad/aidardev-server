...
const hypeTopics: Array<{
  ...
  {
    id: 'karaganda-digital-sales',
    service: 'цифровые продажи для бизнеса',
    category: { ru: 'Маркетинг и IT', kz: 'Маркетинг және IT' },
    path: 'consulting',
    city: 'Караганда',
    intent: 'с чего начать digital',
    hook: 'С чего начать digital-продажи в Караганде без хаоса',
    hypeScore: 85,
    keywords: ['сайт для бизнеса караганда', 'digital маркетинг караганда', 'заявки онлайн караганда', 'автоматизация продаж'],
  },
