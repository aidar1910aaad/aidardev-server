...
const hypeTopics: Array<{
  ...
  // GSC-confirmed high-intent clusters (Search Console 2025–2026)
  {
    id: 'gsc-ux-design-order',
    service: 'заказать ux/ui дизайн',
    category: { ru: 'Дизайн', kz: 'Дизайн' },
    path: 'design',
    city: 'Казахстан',
    intent: 'заказать ux дизайн сайта',
    hook: 'Как заказать UX/UI-дизайн сайта и не получить «красивую картинку» без заявок',
    hypeScore: 99,
    keywords: ['заказать ux дизайн сайта', 'ux ui дизайн заказать', 'ux-дизайн заказать', 'ui ux дизайн казахстан'],
  },
  {
    id: 'gsc-mobile-astana',
    service: 'мобильные приложения астана',
    category: { ru: 'Мобильная разработка', kz: 'Мобильді әзірлеу' },
    path: 'mobile',
    city: 'Астана',
    intent: 'разработка приложений астана',
    hook: 'Разработка мобильных приложений в Астане: с чего начать и сколько стоит MVP',
    hypeScore: 99,
    keywords: ['создание мобильных приложений астана', 'разработка приложений астана', 'разработка мобильных приложений астана', 'mvp приложение астана'],
  },
  {
    id: 'gsc-ecommerce-open-kz',
    service: 'интернет-магазин казахстан',
    category: { ru: 'E-commerce', kz: 'E-commerce' },
    path: 'websites',
    city: 'Казахстан',
    intent: 'открыть интернет магазин',
    hook: 'Как открыть интернет-магазин в Казахстане без лишних ошибок на старте',
    hypeScore: 98,
    keywords: ['как открыть интернет магазин в казахстане', 'открыть интернет магазин в казахстане', 'интернет магазин казахстан', 'интернет магазин под ключ'],
  },
  {
    id: 'gsc-bots-almaty',
    service: 'разработка ботов алматы',
    category: { ru: 'Автоматизация', kz: 'Автоматтандыру' },
    path: 'bots',
    city: 'Алматы',
    intent: 'разработка ботов алматы',
    hook: 'Разработка ботов в Алматы: Telegram или WhatsApp — что выбрать под ваш бизнес',
    hypeScore: 98,
    keywords: ['разработка ботов алматы', 'разработка чат ботов алматы', 'telegram бот алматы', 'whatsapp бот алматы'],
  },
